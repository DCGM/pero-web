...
{% block content %}
    <p>
        Naší snahou je získat velkou databází ručně přepsaných stránek textu, s cílem vytvořit nástroj pro autmotické přepisování českých historických dokumentů.
    ...
    <p>
        Stáhněte si prosím náhodnou šablonu pomocí tlačítka níže, vytiskněte si ji a na stejnou stranu přepište vzorový text.
        Prosíme, zachovejte řádkování a případné pravopisné chyby.
        Ukázka přepsané stránky se nachází pod formulářem.
    </p>
    <p>
        ...
        Alternativně můžete zaslat přepsané stránky na adresu Michal Hradiš, Fakulta informačních technologií VUT v Brně, Božetěchova 1/2, 612 00 Brno.
        Zasláním přepsaných stránek souhlasíte s jejich anonymní distribucí a použitím bez jakýchkoliv omezení.
    </p>
    ...
    <form id="handwritten_dataset_form" lang="cs" action="/handwritten_dataset" method="POST" enctype="multipart/form-data">
        <div class="input-default-wrapper mt-5">
            <div class="input-group">
                <div class="input-group-text mb-3" id="hwr_get_button" onclick="getRandomHandwrittenPage()">Získat náhodnou šablonu</div>
            </div>
