...
{% block perex %}
    <p>Jan Kohút published a <a href="http://excel.fit.vutbr.cz/submissions/2019/048/48.pdf">research paper</a> on active learning for historic OCR and gave an oral presentation at student conference <a href="http://excel.fit.vutbr.cz/vysledky/">Excel@FIT</a>.</p>
{% endblock %}
